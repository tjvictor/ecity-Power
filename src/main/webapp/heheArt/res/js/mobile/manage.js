...
function memberInit(){
    ...
    callAjax('/heheArtService/getMembers', '', 'getMembersCallback', '', '', '', '');
}
function getMembersCallback(data) {
    if (data.status == "ok") {
        ...
        $('.hehe-open-popup').on('click', function() {
...
function generateMember(member) {
    ...
    template += '   <div data-id="' + member.id + '" class="weui-cell__bd hehe-open-popup">';
...
function deleteMember(obj) {
    ...
    function() {
        callAjax('/heheArtService/deleteMember', '', 'deleteMemberCallback', '', '', 'id=' + id, '');
    },
    function() {
...
function notificationInit(){
    ...
    $('.add_notification_btn').on('click', function() {
        ...
        callAjax('/heheArtService/addNotification', '', 'addNotificationCallback', '', 'POST', postValue, '');
    });

    callAjax('/heheArtService/getNotifications', '', 'getNotificationsCallback', '', '', '', '');
}
...
function generateNotification(notification) {
    var template = '';
    template += '<div class="weui-cell weui-cell_swiped">';
    template += '   <div data-id="' + notification.id + '" class="weui-cell__bd hehe-open-popup">';
    template += '       <div class="weui-cell">';
    template += '           <div class="weui-cell__bd">';
...
function deleteNotification(obj) {
    ...
    $.confirm("您确定要删除吗?", "确认删除?",
    function() {
        callAjax('/heheArtService/deleteNotification', '', 'deleteNotificationCallback', '', '', 'id=' + id, '');
    },
    function() {
...
function scheduleInit(){
    ...
    $("#searchDate").calendar({
        ...
        onChange: function (p, values, displayValues) {
            ...
            callAjax('/heheArtService/getFullScheduleByDate', '', 'getFullScheduleByDateCallback', '', '', param, '');
        }
    });
    ...
    $('.add_schedule_btn').on('click', function() {
        ...
        callAjax('/heheArtService/addSchedule', '', 'addScheduleCallback', '', 'POST', postValue, '');
    });

    callAjax('/heheArtService/getCourses', '', 'getCoursesCallback', '', '', '', '');
    callAjax('/heheArtService/getTeachers', '', 'getTeachersCallback', '', '', '', '');
}
...
function generateSchedule(schedule) {
    var template = '';
    template += '<div class="weui-cell weui-cell_swiped">';
    template += '   <div data-id="' + schedule.id + '" class="weui-cell__bd hehe-open-popup">';
    template += '       <div class="weui-cell">';
    template += '           <div class="weui-cell__bd">';
...
function deleteSchedule(obj) {
    ...
    $.confirm("您确定要删除吗?", "确认删除?",
    function() {
        callAjax('/heheArtService/deleteSchedule', '', 'deleteScheduleCallback', '', '', 'id=' + id, '');
    },
    function() {
