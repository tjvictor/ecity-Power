...
import ecity_power.dao.heheArt.NotificationDao;
import ecity_power.model.heheArt.Notification;
...
@Component
public class NotificationDaoImp extends heheArtBaseDao implements NotificationDao {
    @Override
