package ecity_power.service.heheArt;

import ecity_power.dao.heheArt.*;
import ecity_power.model.FileUploadEntity;
import ecity_power.model.ResponseObject;
import ecity_power.model.heheArt.*;
...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping("/heheArtService")
public class heheArtService {

    //region private
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    private final static String SERVICE_URL_PREFIX = "heheArt/";
