...
r=96),"undefined"!=typeof wx&&"en_US"==wx.lang&&(i=125,r=125),t.id=i,t.key=r,{
id:i,
key:r
};
}
...
e.onerror=function(n,r,t,c,a){
var s=n;
a&&a.stack&&(s=d(a)),o(s,"Event")&&(s+=s.type?"--"+s.type+"--"+(s.target?s.target.tagName+"::"+s.target.src:""):""),
r&&r.length>0&&0==/^https\:\/\/(mp\.weixin\.qq\.com|res\.wx\.qq\.com)/.test(r)||(1!=t||1!=c&&86!=c||-1!=n.indexOf("eval"))&&0!=i(s,window.navigator.userAgent)&&(S.push({
msg:s+"|onerror",
target:r,
rowNum:t,
colNum:c
...
o.push(g+":"+s),i.push(g+"="+encodeURIComponent(s)),r.push(g+"["+n+"]="+encodeURIComponent(s));
}
}
}
...
for(var i in f)if(f[i]==n)return;
if(f.push(n),t.submit)t.submit(e);else{
var r=new Image;
u.push(r),r.src=e;
}
var o="error";
if(o=e.match(/msg=(.*?)&/),o&&o[1]&&(o=o[1]),wx&&wx.uin&&(o+=encodeURIComponent("|uin|"+wx.uin)),
t.key){
var r=new Image;
r.src="https://mp.weixin.qq.com/misc/jslog?id="+t.key+"&content="+o+"&level=error";
}
var c=new Image;
c.src="https://mp.weixin.qq.com/misc/jslog?id=65&content="+o+"&level=error";
},p=[],h=0,I=function(e){
if(t.report){
for(;r.length;){
var n=!1,i=r.shift(),c=m(i,p.length);
if(o(t.ignore,"Array"))for(var a=0,g=t.ignore.length;g>a;a++){
var s=t.ignore[a];
if(o(s,"RegExp")&&s.test(c[1])||o(s,"Function")&&s(i,c[1])){
n=!0;
break;
}
}
n||(t.combo?p.push(c[0]):l(t.report+c[2]+"&_t="+ +new Date),t.onReport&&t.onReport(t.id,i));
}
var d=p.length;
if(d){
var u=function(){
clearTimeout(h),console.log("comboReport"+p.join("&")),l(t.report+p.join("&")+"&count="+d+"&_t="+ +new Date),
h=0,p=[];
};
...
if(i){
var o=new Image;
o.src=t.url+"?id="+i+"&msg="+encodeURIComponent(n)+"&uin="+(wx&&wx.uin)+"&from="+encodeURIComponent(location.href)+"&level=4";
}
},
getConfig:function(){
return t;
...
},0,!0),t.id=S.IDS.DEFAULT,t.key=S.KEY,"undefined"==typeof wx&&(wx={}),n(),S.init(),
S;
}(window);